...
MODEL_DIR = "../models/soh"
MODEL_PATH = os.path.join(MODEL_DIR, "soh_model.joblib")
...
# battery_id and usage_profile are text columns.
# Convert them to numerical dummy variables.
...
print("\nTraining Random Forest SOH model...")
